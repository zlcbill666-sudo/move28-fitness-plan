...
const modules = Object.freeze({
  ...
  scheduleShift: path.join(projectRoot, 'src', 'domain', 'schedule-shift.js'),
  ...
  exerciseMediaPolicy: path.join(projectRoot, 'src', 'data', 'exercise-media-policy.js'),
