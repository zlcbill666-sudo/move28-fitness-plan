...
exercise({id:'dead-bug',name:'死虫式',pattern:'anti_extension',settings:['gym','home'],equipmentOptions:[['exercise_mat']],difficulty:1,dose:strengthDose,contraindications:['floor'],gif:'assets/gifs/14_死虫式.gif'},{groups:['力量B'],start:'仰卧，髋膝约90度，双臂可放身体两侧；腰部轻轻贴地。',steps:'腹部收紧，交替让一侧脚跟缓慢点地再收回；保持腰部不拱起。',breath:'脚跟下放时呼气，收回时吸气。',errors:'腰部离地；动作过快；腿伸得过低；憋气。',safety:'腰部不适时减小幅度或改坐姿交替抬膝。'}),
