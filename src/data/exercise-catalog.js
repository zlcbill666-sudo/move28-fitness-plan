...
const MEDIA_POLICY_BY_EXERCISE=deepFreeze(Object.assign(Object.create(null),{
  "seated-leg-raise":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"坐姿抬腿",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"后倾训练凳上双腿同时抬高，属于核心训练，不是有靠背椅上小幅交替抬膝。"},
  "ankle-circle":{mediaLaunchStatus:"near_pending",mediaMatchVerdict:"near",mediaRightsStatus:"blocked",approvedDisplayName:"脚踝绕环",sourceExerciseDbId:"uL9CsKm",sourceExerciseDbName:"ankle circles",mediaFailureReason:"踝绕环轨迹接近，但候选为站姿交叉腿，无稳固座椅支撑。"},
  ...
  "wall-hip-hinge":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"墙触髋铰链",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"全库未发现背对墙、臀部后移轻触墙面的徒手髋铰链。"},
  ...
  "standing-band-chest-press":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"站姿弹力带推胸",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"候选为坐姿弹力带推胸，不是前后分腿站姿双手推胸。"},
  ...
  "band-row":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"弹力带划船",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"候选坐姿且弹力带绕脚，不是胸高固定点站姿划船。"},
  ...
  "high-seat-sit-to-stand":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"高位坐姿起立",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"候选为扶物下蹲，臀部不接触高位稳固座面。"},
  ...
  "seated-knee-extension-unloaded":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"坐姿徒手伸膝",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"全库未发现有靠背椅上交替单侧无负重伸膝。"},
  "supported-calf-raise":{mediaLaunchStatus:"near_pending",mediaMatchVerdict:"near",mediaRightsStatus:"blocked",approvedDisplayName:"扶椅提踵",sourceExerciseDbId:"bJYHBIN",sourceExerciseDbName:"bodyweight standing calf raise",mediaFailureReason:"平地双脚提踵轨迹匹配，但没有双手轻扶稳固椅背。"},
  ...
  "dead-bug":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"死虫式",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"候选为对侧手脚伸展，难度和轨迹不等于双臂体侧交替脚跟点地。"},
  "heel-slide":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"仰卧脚跟滑动",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"候选从双腿伸直开始再屈膝，不符合双膝屈曲起始、单侧脚跟前滑合同。"},
  "bird-dog-regression":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"四点支撑单肢滑动",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"全库未发现手不离垫的四点支撑单肢贴垫滑动。"},
  ...
  "flat-walk":{mediaLaunchStatus:"near_pending",mediaMatchVerdict:"near",mediaRightsStatus:"blocked",approvedDisplayName:"平地慢走",sourceExerciseDbId:"rjiM4L3",sourceExerciseDbName:"walking on incline treadmill",mediaFailureReason:"跑台步行轨迹匹配，但候选明确为上坡跑台，合同要求0坡度。"},
  "supported-standing-march":{mediaLaunchStatus:"near_pending",mediaMatchVerdict:"near",mediaRightsStatus:"blocked",approvedDisplayName:"扶椅原地踏步",sourceExerciseDbId:"ealLwvX",sourceExerciseDbName:"high knee against wall",mediaFailureReason:"交替抬膝匹配，但以墙支撑且幅度较高，不是双手扶椅小幅踏步。"},
  "hamstring-stretch":{mediaLaunchStatus:"gap_blocked",mediaMatchVerdict:"gap",mediaRightsStatus:"blocked",approvedDisplayName:"大腿后侧拉伸",sourceExerciseDbId:null,sourceExerciseDbName:null,mediaFailureReason:"候选在椅上动态抬放直腿，没有进入并保持轻柔静态牵拉。"},
  "calf-stretch":{mediaLaunchStatus:"near_pending",mediaMatchVerdict:"near",mediaRightsStatus:"blocked",approvedDisplayName:"小腿拉伸",sourceExerciseDbId:"17bqEXD",sourceExerciseDbName:"seated calf stretch (male)",mediaFailureReason:"坐地并用手拉脚，合同要求坐稳椅面且不借助外力主动勾脚。"}
}));
