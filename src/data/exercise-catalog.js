...
const EQUIPMENT_IDS=deepFreeze(['stable_chair','stable_high_bench','smith_machine','exercise_mat','leg_press_machine','leg_curl_machine','chest_press_machine','seated_row_machine','resistance_band','cable_machine','leg_extension_machine','hip_abduction_machine','wall','elliptical_trainer','treadmill','flat_walking_route']);
...
const MEDIA_POLICY_BY_EXERCISE=deepFreeze(Object.assign(Object.create(null),{
  ...
  "ankle-circle":{"mediaLaunchStatus":"exact_ready","mediaMatchVerdict":"exact","mediaRightsStatus":"confirmed","approvedDisplayName":"站姿脚踝绕环","sourceExerciseDbId":"uL9CsKm","sourceExerciseDbName":"ankle circles","mediaFailureReason":"动作内容已按当前动作图重新对齐：站姿脚踝绕环。"},
  ...
  "wall-hip-hinge":{"mediaLaunchStatus":"near_approved","mediaMatchVerdict":"approved_near","mediaRightsStatus":"confirmed","approvedDisplayName":"弹力带拉髋","sourceExerciseDbId":"VtTbiP3","sourceExerciseDbName":"band pull through","mediaFailureReason":"用户授权将原墙触髋铰链改为动作库相近的弹力带拉髋；已同步为低位弹力带髋铰链口径。"},
  ...
  "standing-band-chest-press":{"mediaLaunchStatus":"near_approved","mediaMatchVerdict":"approved_near","mediaRightsStatus":"confirmed","approvedDisplayName":"坐姿弹力带推胸","sourceExerciseDbId":"4x5Okof","sourceExerciseDbName":"resistance band seated chest press","mediaFailureReason":"用户明确授权将原站姿弹力带推胸改为坐姿弹力带推胸，并替换为本地ExerciseDB坐姿弹力带推胸动图。"},
  ...
  "band-row":{"mediaLaunchStatus":"near_approved","mediaMatchVerdict":"approved_near","mediaRightsStatus":"confirmed","approvedDisplayName":"单臂弹力带低位划船","sourceExerciseDbId":"km0sQC0","sourceExerciseDbName":"band one arm standing low row","mediaFailureReason":"用户授权按安全建议替换为本地ExerciseDB已复核近似图：单臂站姿弹力带低位划船；动作步骤已同步为左右单臂执行。"},
  ...
  "high-seat-sit-to-stand":{"mediaLaunchStatus":"exact_ready","mediaMatchVerdict":"exact","mediaRightsStatus":"confirmed","approvedDisplayName":"史密斯椅子深蹲","sourceExerciseDbId":"Gu2rNJd","sourceExerciseDbName":"smith chair squat","mediaFailureReason":"动作内容已按当前动作图重新对齐：史密斯辅助椅子深蹲。"},
  ...
  "seated-knee-extension-unloaded":{"mediaLaunchStatus":"near_approved","mediaMatchVerdict":"approved_near","mediaRightsStatus":"confirmed","approvedDisplayName":"坐姿弹力带伸膝","sourceExerciseDbId":"Y1MsI1l","sourceExerciseDbName":"resistance band leg extension","mediaFailureReason":"用户明确授权将原坐姿徒手伸膝改为坐姿弹力带伸膝，并替换为本地ExerciseDB弹力带伸膝动图；已按视觉复核限定为坐姿版本。"},
  "supported-calf-raise":{"mediaLaunchStatus":"near_approved","mediaMatchVerdict":"approved_near","mediaRightsStatus":"confirmed","approvedDisplayName":"站姿支撑提踵","sourceExerciseDbId":"bJYHBIN","sourceExerciseDbName":"bodyweight standing calf raise","mediaFailureReason":"用户授权按安全建议替换为本地ExerciseDB已复核近似图：站姿自重提踵；产品文案限定为必要时扶墙或椅背保持平衡。"},
  ...
  "heel-slide":{"mediaLaunchStatus":"near_approved","mediaMatchVerdict":"approved_near","mediaRightsStatus":"confirmed","approvedDisplayName":"仰卧单腿滑动","sourceExerciseDbId":"LNE3wfo","sourceExerciseDbName":"single leg platform slide","mediaFailureReason":"用户授权按安全建议替换为本地ExerciseDB已复核近似图：仰卧单腿平台滑动；动作步骤已同步为脚跟/足部沿毛巾、滑垫或光滑地面滑动。"},
  "bird-dog-regression":{"mediaLaunchStatus":"near_approved","mediaMatchVerdict":"approved_near","mediaRightsStatus":"confirmed","approvedDisplayName":"跪姿平板肩触碰","sourceExerciseDbId":"h1ezqSu","sourceExerciseDbName":"kneeling plank tap shoulder (male)","mediaFailureReason":"用户授权将原四点支撑单肢滑动改为动作库相近的跪姿平板肩触碰；已同步为核心稳定退阶口径。"},
  ...
  "flat-walk":{"mediaLaunchStatus":"exact_ready","mediaMatchVerdict":"exact","mediaRightsStatus":"confirmed","approvedDisplayName":"坡度跑台慢走","sourceExerciseDbId":"rjiM4L3","sourceExerciseDbName":"walking on incline treadmill","mediaFailureReason":"动作内容已按当前动作图重新对齐：低速坡度跑台慢走。"},
  "supported-standing-march":{"mediaLaunchStatus":"near_approved","mediaMatchVerdict":"approved_near","mediaRightsStatus":"confirmed","approvedDisplayName":"扶墙支撑原地抬膝","sourceExerciseDbId":"ealLwvX","sourceExerciseDbName":"high knee against wall","mediaFailureReason":"用户授权按安全建议替换为本地ExerciseDB已复核近似图：扶墙高抬腿；产品文案限定为扶墙或稳定椅背的小幅受控抬膝。"},
...
exercise({id:'ankle-circle',name:'站姿脚踝绕环',pattern:'mobility',settings:['gym','home'],equipmentOptions:[['stable_chair']],difficulty:1,dose:warmupDose,gif:'assets/gifs/03_脚踝绕环.gif'},{groups:['力量A','力量B'],start:'站姿保持身体直立，双脚并拢或与髋同宽；需要稳定时轻扶椅背或固定支撑，一侧脚尖轻点地。',steps:'按动图示范让脚踝缓慢画圆，顺时针10次、逆时针10次，然后换脚；膝盖和髋部尽量保持安静。',breath:'自然呼吸。',errors:'身体左右晃动；整条腿大幅摆动；速度过快；脚踝用力压到疼痛。',safety:'先确认站立稳定，必要时扶稳支撑；踝部锐痛、明显不稳或接近失衡时停止。'}),
...
exercise({id:'wall-hip-hinge',name:'弹力带拉髋',pattern:'hinge',settings:['home','gym'],equipmentOptions:[['resistance_band']],difficulty:1,dose:strengthDose,contraindications:['hinge'],progressionIds:['glute-bridge'],gif:'assets/gifs/20_墙触髋铰链.gif'},{groups:['力量A'],start:'将弹力带牢固固定在身后低位，背对固定点站立，双脚与髋同宽，膝盖微屈，双手握住弹力带从两腿之间向前保持轻张力。',steps:'保持脊柱中立，将臀部向后送形成髋铰链；感到大腿后侧和臀部轻微张力后，收紧臀部站直，不把动作做成下蹲。',breath:'向后送髋时吸气，站直时呼气。',errors:'固定点不牢；弓腰或抬头；膝盖大幅前移变成下蹲；用手臂拉带代替髋部发力；弹力带快速回弹。',safety:'先确认弹力带、固定点和脚下稳定，并使用轻阻力；腰、髋或大腿后侧出现锐痛、麻木或放射痛时立即停止。'}),
...
exercise({id:'standing-band-chest-press',name:'坐姿弹力带推胸',pattern:'horizontal_push',settings:['home','gym'],equipmentOptions:[['stable_chair','resistance_band']],difficulty:1,dose:strengthDose,progressionIds:['chest-press-machine'],gif:'assets/gifs/21_站姿弹力带推胸.gif'},{groups:['力量A','力量B'],start:'坐在稳固椅子或长凳上，双脚踩地，背部直立；弹力带绕过上背或固定在身后胸口高度，双手握带置于胸侧，肩膀远离耳朵。',steps:'保持躯干稳定，将双手平稳向前推至手肘接近伸直但不锁死；短暂停顿，再受控回到胸侧。',breath:'向前推时呼气，受控回位时吸气。',errors:'椅子不稳；肋骨外翻或身体后仰；耸肩；手肘锁死；弹力带快速弹回。',safety:'先确认座椅、弹力带和固定点牢固并使用轻阻力；肩、胸、肘或腰出现锐痛时立即停止。'}),
...
exercise({id:'band-row',name:'单臂弹力带低位划船',pattern:'horizontal_pull',settings:['home','gym'],equipmentOptions:[['resistance_band']],difficulty:1,dose:strengthDose,progressionIds:['seated-row'],gif:'assets/gifs/19_弹力带划船.gif'},{groups:['力量A','力量B'],start:'将弹力带牢固固定在低位至腰部高度，面对固定点稳定站立，双脚与髋同宽；单手握住弹力带，另一手可轻扶髋部或固定支撑。',steps:'保持肩膀远离耳朵，一侧手肘贴近身体向后拉至手靠近髋部或下肋；短暂停顿，再受控伸臂回到起点，完成次数后换侧。',breath:'后拉时呼气，受控回位时吸气。',errors:'固定点不牢；耸肩；身体旋转或后仰借力；肘向外张开；弹力带快速弹回。',safety:'先确认固定点牢固并使用轻阻力；肩、肘或腰出现锐痛时立即停止。'}),
...
exercise({id:'high-seat-sit-to-stand',name:'史密斯椅子深蹲',pattern:'knee_dominant',settings:['gym'],equipmentOptions:[['smith_machine','stable_high_bench'],['smith_machine','stable_chair']],difficulty:1,dose:strengthDose,progressionIds:['seated-leg-press'],gif:'assets/gifs/10_高位坐姿起立.gif',variantGuidance:{high_seat:{label:'史密斯椅子深蹲变式',setup:'仅在健身房同时具备史密斯机和稳定座椅/高凳时使用；只用空杆或极轻负重。',range:'臀部轻触座椅后站起，膝部无痛且动作可控；不能稳定触椅、无史密斯机或站起失稳时停止。'}}},{groups:['力量B'],start:'站在史密斯机内的稳定座椅或高凳前，脚略宽于肩、脚尖微向外；确认史密斯轨道、空杆或极轻阻力和座椅都已固定。',steps:'双手轻扶史密斯杆保持轨道内稳定，臀部向后下坐至轻触座椅，再脚掌发力站起；保持膝盖与脚尖同向，躯干稳定，不直接跌坐。',breath:'站起时呼气，坐下时吸气。',errors:'膝盖内扣；借史密斯杆猛拉起身；下坐过深或砸坐；无史密斯机时按本动图执行。',safety:'只在史密斯机和稳定座椅/高凳同时可用时执行；先用空杆或极轻阻力；膝、腰出现锐痛或无法稳定控制座椅触点时停止。'}),
...
exercise({id:'seated-knee-extension-unloaded',name:'坐姿弹力带伸膝',pattern:'knee_extension',settings:['home','gym'],equipmentOptions:[['stable_chair','resistance_band']],difficulty:1,dose:strengthDose,progressionIds:['seated-leg-extension'],gif:'assets/gifs/22_坐姿徒手伸膝.gif'},{groups:['力量B'],start:'坐在稳固椅子或长凳上，背部保持直立，双手轻扶椅面；将轻阻力弹力带固定在脚踝附近并确认不会滑脱。',steps:'保持大腿稳定，缓慢伸直一侧膝盖至接近伸直但不锁死；短暂停顿，再受控放回并按计划换腿。',breath:'伸膝时呼气，放回时吸气。',errors:'身体后仰借力；甩腿；膝盖锁死；大腿离开椅面；弹力带滑脱或回落过快。',safety:'先使用轻阻力和舒适幅度；膝前侧出现锐痛、卡住、明显肿胀或弹力带固定不稳时立即停止。'}),
exercise({id:'supported-calf-raise',name:'站姿支撑提踵',pattern:'mobility',settings:['home','gym'],equipmentOptions:[['stable_chair'],['wall']],difficulty:1,dose:strengthDose,gif:'assets/gifs/23_扶椅提踵.gif'},{groups:['力量B','有氧C'],start:'站在墙边或稳固椅背旁，双脚与髋同宽；需要平衡时只用指尖轻扶墙面或椅背，躯干保持直立。',steps:'保持膝盖自然伸展，缓慢抬起双脚跟至舒适高度；停顿1秒，再受控落回，不弹跳。',breath:'抬起时呼气，落下时吸气。',errors:'手臂大力压支撑物；屈膝跳起；脚踝向外翻；快速砸下脚跟。',safety:'先确认墙面、椅子和脚下都稳定；小腿、跟腱或脚踝出现锐痛，或站立不稳时立即停止。'}),
...
exercise({id:'heel-slide',name:'仰卧单腿滑动',pattern:'anti_extension',settings:['home','gym'],equipmentOptions:[['exercise_mat']],difficulty:1,dose:strengthDose,contraindications:['floor'],progressionIds:['dead-bug'],gif:'assets/gifs/25_仰卧脚跟滑动.gif'},{groups:['力量B'],start:'仰卧在垫上，双膝弯曲，脚跟或足部放在毛巾、滑垫或光滑地面上；腹部轻收，腰背保持自然稳定。',steps:'让一侧脚跟或足部沿地面缓慢向前滑，滑至腰背仍稳定的范围；再沿原路受控收回并换侧。',breath:'脚跟向前滑时呼气，收回时吸气。',errors:'脚跟离地甩腿；腰部拱起；腿完全甩直；动作过快；憋气。',safety:'地面起落不安全或被要求避免地面动作时不做；腰、髋或膝出现锐痛时立即停止。'}),
exercise({id:'bird-dog-regression',name:'跪姿平板肩触碰',pattern:'anti_extension',settings:['home','gym'],equipmentOptions:[['exercise_mat']],difficulty:1,dose:strengthDose,contraindications:['floor'],progressionIds:['dead-bug'],gif:'assets/gifs/26_四点支撑单肢滑动.gif'},{groups:['力量B'],start:'在垫上进入跪姿平板支撑，双手或前臂稳定支撑，肩、髋和膝保持成一条稳定斜线，腹部轻收。',steps:'保持骨盆和躯干尽量不晃动，缓慢抬起一只手轻触对侧肩部或向前点触，再受控放回并换侧。',breath:'抬手点触时呼气，放回时吸气。',errors:'塌腰；臀部左右晃动；耸肩；手快速拍打；屏住呼吸。',safety:'手腕、肩、膝或腰出现锐痛时立即停止；需要时在膝下增加软垫，避免地面者不做。'}),
exercise({id:'elliptical-trainer',name:'椭圆机／交叉训练机',pattern:'cardio',settings:['gym'],equipmentOptions:[['elliptical_trainer']],difficulty:1,dose:cardioDose,regressionIds:['flat-walk'],gif:'assets/gifs/15_椭圆机.gif'},{groups:['力量A','力量B','有氧C'],start:'双脚踩稳踏板，双手轻扶固定把手，躯干直立；先确认膝盖与脚尖方向一致。',steps:'力量日前用最低阻力慢速热身8～10分钟；有氧日先慢5分钟，再进入RPE 4～5。步幅保持小而顺，不追求速度。',breath:'自然、连续呼吸；全程能说短句，不憋气。',errors:'死死抓把手；身体前趴；阻力过高；步幅过大；突然停止。',safety:'膝或腰不适时先降阻力、缩短步幅；仍不适则改为低速慢走或停止。'}),
exercise({id:'flat-walk',name:'坡度跑台慢走',pattern:'locomotion',settings:['gym','home','outdoors'],equipmentOptions:[['treadmill'],['flat_walking_route']],difficulty:1,dose:cardioDose,regressionIds:['supported-standing-march'],gif:'assets/gifs/16_平地慢走.gif'},{groups:['力量A','力量B','有氧C'],start:'按动图使用跑步机低速慢走，坡度保持在能稳定说短句的轻度范围；没有跑步机时选择平整路线慢走。先站稳、系好鞋带，再逐步启动。',steps:'力量日前慢走8～10分钟热身；有氧阶段保持自然小步幅和低速，结束前逐步降速3～5分钟。全程只走路，不跑步。',breath:'自然呼吸，能说短句。',errors:'扶住扶手悬挂身体；跨大步；速度或坡度过高；突然下机；为了跟动图而超出自身稳定范围。',safety:'坡度和速度都以稳定、无痛、能说短句为上限；平衡不稳时降速、降坡度并扶固定把手，仍不稳则停止。'}),
exercise({id:'supported-standing-march',name:'扶墙支撑原地抬膝',pattern:'locomotion',settings:['home','gym'],equipmentOptions:[['wall'],['stable_chair']],difficulty:1,dose:supportedCardioDose,progressionIds:['flat-walk'],gif:'assets/gifs/24_扶椅原地踏步.gif'},{groups:['力量A','力量B','有氧C'],start:'面对墙面站稳，双手轻触墙面；也可改扶稳固椅背。双脚与髋同宽，先确认身体站稳。',steps:'交替抬起一侧膝盖至舒适高度，再受控放下；保持小幅、缓慢、连续，不追求抬高或速度。',breath:'自然连续呼吸，全程能够说短句。',errors:'手臂悬挂身体；膝盖抬得过高；身体左右摇晃；快速跺脚；憋气。',safety:'先做2分钟并随时停下；胸痛、接近晕厥、异常气短或明显不稳时立即停止。'}),
